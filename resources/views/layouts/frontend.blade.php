...
<div class="spinner-wrapper" id="preloader">
    <div class="spinner-container">
        <div class="spinner-outer">
            ...
            <p class="spinner-text">Real Etate</p>
        </div>
    </div>
</div>
                    ...
                    <div class="theme-container row between-xs middle-xs h-100">
                        ...
                        <div class="row end-xs middle-xs">
                            ...
                            <div class="mdc-menu-surface--anchor">
                                <button class="mdc-button mdc-ripple-surface mutable">
                                    <span class="mdc-button__ripple"></span>
                                    <img src="{{asset('frontend/assets/images/flags/gb.svg')}}" alt="" width="18">
                                    <span class="mdc-button__label flag-name d-none d-lg-flex d-xl-flex"><span
                                            class="mutable">English</span></span>
                                    <i class="material-icons mdc-button__icon m-0">arrow_drop_down</i>
                                </button>
                                <div class="mdc-menu mdc-menu-surface">
                                    <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical"
                                        ...
                                        <li class="mdc-list-item" role="menuitem">
                                            <img src="{{asset('frontend/assets/images/flags/de.svg')}}" alt="" width="18"
                                                 class="mdc-elevation--z1">
                                            <span class="mdc-list-item__text flag-name">German</span>
                                        </li>
                                        <li class="mdc-list-item" role="menuitem">
                                            <img src="{{asset('frontend/assets/images/flags/fr.svg')}}" alt="" width="18"
                                                 class="mdc-elevation--z1">
                                            <span class="mdc-list-item__text flag-name">French</span>
                                        </li>
                                        <li class="mdc-list-item" role="menuitem">
                                            <img src="{{asset('frontend/assets/images/flags/ru.svg')}}" alt="" width="18"
                                                 class="mdc-elevation--z1">
                                            <span class="mdc-list-item__text flag-name">Russian</span>
                                        </li>
                                        <li class="mdc-list-item" role="menuitem">
                                            <img src="{{asset('frontend/assets/images/flags/tr.svg')}}" alt="" width="18"
                                                 class="mdc-elevation--z1">
                                ...
                                <div class="mdc-menu mdc-menu-surface user-menu">
                                    <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical"
                                        ...
                                        <li class="user-info row start-xs middle-xs">
                                            <img src="{{asset('frontend/assets/images/others/user.jpg')}}" alt="user-image" width="50">
                ...
                <div id="main-toolbar" class="mdc-elevation--z2">
                    <div class="theme-container row between-xs middle-xs h-100">
                                    ...
                                    <div class="mdc-list">
                                        ...
                                        <div class="mdc-menu-surface--anchor">
                                            ...
                                            <div class="mdc-menu mdc-menu-surface">
                                                <div class="mdc-list">
                                                    <div>
                                                        <a href="http://themeseason.com/" target="_blank"
                                                           class="mdc-button">
                                                            <span class="mdc-button__ripple"></span>
                        ...
                        <div class="row middle-xs">
                            <a href="favorites.html" class="mdc-icon-button material-icons d-none d-lg-flex d-xl-flex"
                               title="Favorites">favorite_border</a>
                            <a href="compare.html"
                               class="mdc-icon-button material-icons d-none d-lg-flex d-xl-flex mr-3 ml-2"
                               title="Compare list">compare_arrows</a>
                            <a href="submit-property.html"
                               class="mdc-fab mdc-fab--mini primary d-sm-none d-md-none d-lg-none d-xl-none">
                        ...
                        <div class="py-5 content">
                            <div class="row between-xs">
                                <div class="col-xs-12 col-sm-5 col-md-4 p-0">
                                    ...
                                    <p class="mt-5 mb-3 desc">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                        Nostrum
