                    ...
                    <div class="col-xs-12 col-lg-6 col-xl-6 p-3">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 p-2">
                                ...
                                <p class="text-muted fw-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                    Vitae dolor magnam, facilis voluptas quia excepturi provident cupiditate.</p>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 p-2">
...
{{--                                    <p class="text">Donec molestie turpis ut mollis efficitur. Nam fringilla libero vel--}}
{{--                                        dictum vulputate. In malesuada, ligula non ornare consequat, augue nibh luctus--}}
{{--                                        nisl, et lobortis justo ipsum nec velit. Praesent lacinia quam ut nulla gravida,--}}
{{--                                        at viverra libero euismod. Sed tincidunt tempus augue vitae malesuada.--}}
{{--                                        Vestibulum eu lectus nisi. Aliquam erat volutpat.</p>--}}
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="mdc-card o-hidden">
                                    <div>
                                        <img src="assets/images/others/transparent-bg.png" alt="slide image"
                                             data-src="./assets/images/agents/a-1.jpg"
                                             class="swiper-lazy d-block mw-100">
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                    <div class="p-3">
                                        ...
                                        <p class="mt-3 text-muted fw-500">Phasellus sed metus leo. Donec laoreet, lacus
                                            ut suscipit convallis, erat enim eleifend nulla, at sagittis enim urna et
                                            lacus.</p>
                                        <p class="row middle-xs"><i class="material-icons primary-color"
                                                                    title="Organization">business</i><span
                                                class="mx-2 text-muted fw-500">HouseKey</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">email</i><span
                                                class="mx-2 text-muted fw-500">lusia.m@housekey.com</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">call</i><span
                                                class="mx-2 text-muted fw-500">(224) 267-1346</span></p>
                                        <div class="row pb-3">
                                        ...
                                        <div class="row between-xs middle-xs">
                                            <div class="row start-xs middle-xs">
                                                ...
                                                <a href="http://www.agent.com/" target="blank" class="social-icon"
                                                   title="website">
                                                    <svg class="material-icons text-muted" viewBox="0 0 24 24">
                                                        <path
                            ...
                            <div class="swiper-slide">
                                <div class="mdc-card o-hidden">
                                    <div>
                                        <img src="assets/images/others/transparent-bg.png" alt="slide image"
                                             data-src="./assets/images/agents/a-2.jpg"
                                             class="swiper-lazy d-block mw-100">
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                    <div class="p-3">
                                        ...
                                        <p class="row middle-xs"><i class="material-icons primary-color"
                                                ...
                                                class="mx-2 text-muted fw-500">HouseKey</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">email</i><span
                                                class="mx-2 text-muted fw-500">andy.w@housekey.com</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">call</i><span
                                                class="mx-2 text-muted fw-500">(212) 457-2308</span></p>
                                        <div class="row pb-3">
                                            <div class="divider"></div>
                                        </div>
                                        <div class="row between-xs middle-xs">
                            ...
                            <div class="swiper-slide">
                                <div class="mdc-card o-hidden">
                                    <div>
                                        <img src="assets/images/others/transparent-bg.png" alt="slide image"
                                             data-src="./assets/images/agents/a-3.jpg"
                                             class="swiper-lazy d-block mw-100">
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                    <div class="p-3">
                                        ...
                                        <p class="row middle-xs"><i class="material-icons primary-color"
                                                ...
                                                class="mx-2 text-muted fw-500">HouseKey</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">email</i><span
                                                class="mx-2 text-muted fw-500">tereza.s@housekey.com</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">call</i><span
                                                class="mx-2 text-muted fw-500">(214) 617-2614</span></p>
                                        <div class="row pb-3">
                                            <div class="divider"></div>
                                        </div>
                                        <div class="row between-xs middle-xs">
                            ...
                            <div class="swiper-slide">
                                <div class="mdc-card o-hidden">
                                    <div>
                                        <img src="assets/images/others/transparent-bg.png" alt="slide image"
                                             data-src="./assets/images/agents/a-4.jpg"
                                             class="swiper-lazy d-block mw-100">
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                    <div class="p-3">
                                        ...
                                        <p class="row middle-xs"><i class="material-icons primary-color"
                                                ...
                                                class="mx-2 text-muted fw-500">HouseKey</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">email</i><span
                                                class="mx-2 text-muted fw-500">michael.b@housekey.com</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">call</i><span
                                                class="mx-2 text-muted fw-500">(267) 388-1637</span></p>
                                        <div class="row pb-3">
                                            <div class="divider"></div>
                                        </div>
                                        <div class="row between-xs middle-xs">
                            ...
                            <div class="swiper-slide">
                                <div class="mdc-card o-hidden">
                                    <div>
                                        <img src="assets/images/others/transparent-bg.png" alt="slide image"
                                             data-src="./assets/images/agents/a-5.jpg"
                                             class="swiper-lazy d-block mw-100">
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                    <div class="p-3">
                                        ...
                                        <p class="row middle-xs"><i class="material-icons primary-color"
                                                ...
                                                class="mx-2 text-muted fw-500">HouseKey</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">email</i><span
                                                class="mx-2 text-muted fw-500">michelle.o@housekey.com</span></p>
                                        <p class="row middle-xs"><i class="material-icons primary-color">call</i><span
                                                class="mx-2 text-muted fw-500">(267) 388-1637</span></p>
                                        <div class="row pb-3">
                                            <div class="divider"></div>
