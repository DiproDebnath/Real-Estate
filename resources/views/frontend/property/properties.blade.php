            ...
            <div class="theme-container">
                <div class="page-drawer-container mt-3">
                    ...
                    <div class="page-sidenav-content">
                        ...
                        @endif
                        <div class="properties-wrapper row mt-3">
                                ...
                                <div class="row item col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    <div class="mdc-card property-item grid-item column-3">
                                        <div class="thumbnail-section">
                                            @if($property->statuses != null)
                                                @if($property->statuses[0]->title == 'For Rent')
                                                    <div class="row property-status">
                                                        <span class="blue">{{$property->statuses[0]->title}}</span>
                                                    </div>
                                                @else
                                                    <div class="row property-status">
                                                        <span class="green">{{$property->statuses[0]->title}}</span>
                                                    </div>
                                                @endif
                                            @endif
