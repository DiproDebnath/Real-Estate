...
<!-- Mirrored from www.housekey-html.themeseason.com/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Apr 2020 09:16:36 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <aside class="mdc-drawer mdc-drawer--modal sidenav">
        ...
        <div class="mdc-drawer__content">
            <div class="vertical-menu">
                <div class="mdc-menu-surface--anchor">
                    ...
                    <div class="mdc-menu mdc-menu-surface">
                        <div class="mdc-list">
                            ...
                            <div>
                                <a href="index.blade.php" class="mdc-button">
                                    <span class="mdc-button__ripple"></span>
                ...
                <div>
                    <a href="properties.blade.php" class="mdc-button">
                        <span class="mdc-button__ripple"></span>
                ...
                <div class="mdc-menu-surface--anchor">
                    ...
                    <div class="mdc-menu mdc-menu-surface">
                        <div class="mdc-list">
                            <div>
                                <a href="singleProperty.blade.php" class="mdc-button">
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Single Property</span>
                                </a>
                            </div><div>
                                <a href="agents.blade.php" class="mdc-button">
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Agents</span>
                                </a>
                            </div>
                            <div>
                                <a href="agent.blade.php" class="mdc-button">
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Agent</span>
                                </a>
                            </div>
                            <div>
                                <a href="login.blade.php" class="mdc-button">
                                    <span class="mdc-button__ripple"></span>
                ...
                <div>
                    <a href="about.blade.php" class="mdc-button">
                        <span class="mdc-button__ripple"></span>
                    ...
                    <div class="mdc-menu-surface--anchor">
                        ...
                        <div class="mdc-menu mdc-menu-surface user-menu">
                            <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical" tabindex="-1">
                                ...
                                <li>
                                    <a href="submit-property.blade.php" class="mdc-list-item" role="menuitem">
                                ...
                                <li role="separator" class="mdc-list-divider m-0"></li>
                                <li>
                                    <a href="login.blade.php" class="mdc-list-item" role="menuitem">
        ...
        <div id="main-toolbar" class="mdc-elevation--z2">
            <div class="theme-container row between-xs middle-xs h-100">
                ...
                <div class="row middle-xs">
                    ...
                    <a href="submit-property.blade.php" class="mdc-fab mdc-fab--mini primary d-sm-none d-md-none d-lg-none d-xl-none">
                        <span class="mdc-fab__ripple"></span>
                        <span class="mdc-fab__icon material-icons">add</span>
                    </a>
                    <a href="submit-property.blade.php" class="mdc-button mdc-button--raised d-none d-sm-flex d-md-flex d-lg-flex d-xl-flex">
                        <span class="mdc-button__ripple"></span>
